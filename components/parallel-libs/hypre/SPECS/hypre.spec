...
BuildRequires:  superlu-%{compiler_family}%{PROJ_DELIM} %{mpi_family}-%{compiler_family}%{PROJ_DELIM}
Requires:       superlu-%{compiler_family}%{PROJ_DELIM} %{mpi_family}-%{compiler_family}%{PROJ_DELIM}
